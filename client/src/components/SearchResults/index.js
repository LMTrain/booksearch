      ...
      <ul className="list-group search-results">
        {props.books.map(result => (          
          <li key={result.id} className="list-group-item">
            ...
            <span><button id={result.id}type="submit" onClick={props.handleDetailsSubmit} className="btn btn-success">Detail</button></span><span>  </span>
            
            
   
              
            <span><button id={result.id} type="submit" onClick={props.favoriteSubmit} className="btn btn-success">Add to Favorite</button></span>
